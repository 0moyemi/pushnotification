    ...
    return (
        <div className="min-h-screen bg-[#081f44] lg:pl-72 pt-4">
            <div className="p-4 max-w-2xl mx-auto">
                ...
                {/* Grant Notification Button */}
                {!pushEnabled && (
                    <div className="mb-6 flex flex-col items-center">
                        <button
                            className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-bold py-3 px-6 rounded-xl shadow mb-2"
                            onClick={async () => {
                        ...
                        <div className="text-center text-blue-300 min-h-[2rem]">{status}</div>
                    </div>
                )}
                {/* FCM Token Display */}
                <div className="mb-4">
                ...
                {/* Only show scheduling UI if push is enabled */}
                {pushEnabled && (
                    <React.Fragment>
                        {/* Month/Quick Picker */}
